module Ingenico::Connect::SDK
  ...
  # It is raised when an error response is received from the GlobalCollect platform.
  # It contains data about the returned response.
  class ApiException < RuntimeError

    # Creates a new ApiException that reports an error response from the GlobalCollect platform.
    ...
    # A list of errors received from the GlobalCollect platform;

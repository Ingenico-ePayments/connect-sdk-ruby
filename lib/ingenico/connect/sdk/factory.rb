...
require 'ingenico/connect/sdk/communicator'
require 'ingenico/connect/sdk/communicator_configuration'
require 'ingenico/connect/sdk/defaultimpl/default_authenticator'
require 'ingenico/connect/sdk/defaultimpl/default_connection'
require 'ingenico/connect/sdk/defaultimpl/default_marshaller'
require 'ingenico/connect/sdk/meta_data_provider'
require 'ingenico/connect/sdk/session'

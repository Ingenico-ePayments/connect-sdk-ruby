...
module Ingenico::Connect::SDK
  module Domain
    module Payment
      ...
      # Class {https://developer.globalcollect.com/documentation/api/server/#schema_ApprovePaymentNonSepaDirectDebitPaymentMethodSpecificInput ApprovePaymentNonSepaDirectDebitPaymentMethodSpecificInput}

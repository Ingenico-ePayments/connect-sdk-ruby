...
module Ingenico::Connect::SDK
  module Domain
    module Token
      ...
      # Class {https://developer.globalcollect.com/documentation/api/server/#schema_UpdateTokenRequest UpdateTokenRequest}
      class UpdateTokenRequest < Ingenico::Connect::SDK::DataObject
        ...
        # {Ingenico::Connect::SDK::Domain::Token::TokenSepaDirectDebitWithoutCreditor}

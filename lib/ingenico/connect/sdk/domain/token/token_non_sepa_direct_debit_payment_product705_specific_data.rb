...
module Ingenico::Connect::SDK
  module Domain
    module Token
      ...
      # Class {https://developer.globalcollect.com/documentation/api/server/#schema_TokenNonSepaDirectDebitPaymentProduct705SpecificData TokenNonSepaDirectDebitPaymentProduct705SpecificData}
